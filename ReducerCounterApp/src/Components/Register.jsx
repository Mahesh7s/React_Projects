...
export default function Register(){
	...
	return(
		...
		<h2>Regster here</h2>
		<input type="text"  placeholder="Enter Your Name:" value={user.name} name="name" onChange={handleChange} /><br/>
		<input type="email" placeholder="Enter Your Email" value ={user.email} name="email" onChange={handleChange} /><br/>
		<input type="password"  placeholder="Enter Your Password" value={user.password} name="password" onChange={handleChange} /><br/>
