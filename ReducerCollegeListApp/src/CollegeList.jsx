    ...
    <div style={{ padding: "20px" }}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input
          ...
          onChange={(e) => dispatch({ type: "UPDATE_ADDRESS_FIELD", field: "building", value: e.target.value })}
        /><br/>

        <input
          placeholder="Street"
          value={state.address.street}
          onChange={(e) => dispatch({ type: "UPDATE_ADDRESS_FIELD", field: "street", value: e.target.value })}
        /><br/>
        ...
        <input
          ...
          onChange={(e) => dispatch({ type: "UPDATE_ADDRESS_FIELD", field: "state", value: e.target.value })}
        /><br/>
      ...
      <div style={{ marginTop: "20px" }}>
        ...
        {state.name === "" ? (
          ...
          <div>
            ...
            <div><strong>Latitude:</strong> {state.address.coordinates.latitude}</div>
            <div><strong>Longitude:</strong> {state.address.coordinates.longitude}</div>
            <div><strong>Courses:</strong> {state.courses_offered.join(", ")}</div>
          </div>
        )}
      </div>
    </div>
