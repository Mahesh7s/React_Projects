...
const baseurl = "https://snacks-45e95-default-rtdb.asia-southeast1.firebasedatabase.app/projects";

export const addProject = createAsyncThunk("Context_slices/addProject",
	async (project) =>{
...
export const deleteProject = createAsyncThunk("Context_slice/deleteProject",
	async (projectId)=>{
...
export const updateProject = createAsyncThunk("Context_slices/updateProject",
	async ({id,updates}) =>{
...
.addCase(fetchProjectById.fulfilled, (state, action) => {
  state.loading = false;
  // Optional: store single project separately
...
// need to add code for  delete and update projects;
